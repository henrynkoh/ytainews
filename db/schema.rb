...
ActiveRecord::Schema[8.0].define(version: 2) do
  create_table "generation_logs", force: :cascade do |t|
    ...
    t.index ["news_article_id", "step"], name: "index_generation_logs_on_news_article_id_and_step"
    t.index ["news_article_id"], name: "index_generation_logs_on_news_article_id"
    t.index ["status"], name: "index_generation_logs_on_status"
  end
  ...
  create_table "news_articles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["created_at"], name: "index_news_articles_on_created_at"
    t.index ["original_url"], name: "index_news_articles_on_original_url", unique: true
    t.index ["published_at"], name: "index_news_articles_on_published_at"
    t.index ["source"], name: "index_news_articles_on_source"
    t.index ["status"], name: "index_news_articles_on_status"
  end
  ...
  add_foreign_key "generation_logs", "news_articles"
